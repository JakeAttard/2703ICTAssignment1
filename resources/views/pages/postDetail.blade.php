...
@section('contentContainer')
  ...
  <div class="row">
    <div class="col-sm-4 form-border"> 
      ...
      <p><a class="btn btn-secondary" href="{{url("/")}}">HomePage</a></p>
      <p><a class="btn btn-secondary" href="{{url("updatePost/$post->postId")}}">Update Post</a></p>
      <p><a class="btn btn-secondary" href="{{url("deletePost/$post->postId")}}">Delete Post</a></p>
    </div>
